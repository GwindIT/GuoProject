package com.idsmanager.basicclient.net;
...
import com.idsmanager.basicclient.application.MyApplication;
...
public class NetService {
    ...
    private static final String RP_LOGIN_SUB = "/RPServer/public/basic/user/login";
    public static String RP_LOGIN_URL;
    private static final String RP_TOKEN_LOGIN_SUB = "/RPServer/public/basic/login";
    public static String RP_TOKEN_LOGIN_URL;
    public static String REGISTER_URL;
    private static final String REGISTER_URL_SUB = "/RPServer/public/basic/user/register";
