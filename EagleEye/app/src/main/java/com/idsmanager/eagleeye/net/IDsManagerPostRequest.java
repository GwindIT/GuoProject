...
public class IDsManagerPostRequest<T extends BaseResponse> extends IDsManagerBaseRequest<T> {
    ...
    public IDsManagerPostRequest(String url, Class<T> cls, Map<String, String> headers, Map<String, String> params, Response.Listener listener, Response.ErrorListener errorListener) {
    ...
    private byte[] encodeParameters(Map<String, String> params, String paramsEncoding) {
        ...
        try {
            ...
            if (mListParams != null && mListParams.size() > 0) {
                for (Map.Entry<String, JSONArray> arrayEntry : mListParams.entrySet()) {
                    obj.put(arrayEntry.getKey(), arrayEntry.getValue());
                }
            }
