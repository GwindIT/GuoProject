...
//            "application/octet-stream";
    ...
    // Transfer-Encoding��Content-Encoding�Ĳ�֮ͬ������:
    // 1, Transfer-Encodingֻ���ڴ�������в��е�,��������URL��Ӧʵ��ı�������.
    // 2, Transfer-Encoding��һ��"������"ͷ,��Content-Encoding��"�˵���"ͷ.
    ...
    public Header getContentType() {
        return new BasicHeader(HEADER_CONTENT_TYPE,
